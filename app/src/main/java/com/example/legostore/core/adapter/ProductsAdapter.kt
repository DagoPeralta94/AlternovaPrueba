...
class ProductsAdapter(
    var productAllList: List<ProductsDetailsDb>,
    private val onClickListener: (ProductsDetailsDb) -> Unit,
    private val onBuyListener: (ProductsDetailsDb) -> Unit
    ...
    override fun onBindViewHolder(holder: ProductsHolder, position: Int) {
        ...
        return holder.render(item, onClickListener, onBuyListener)
    }
